...
//Определяет имя формы и вызывает соответвующую процедуру для добавления полей на форму
	...
	ИначеЕсли ИмяФормы = "Документ.ЗаказПокупателя.Форма.ФормаДокумента" Тогда  
		...
		ДобавитьПолеВГруппуШапкаПраво(Форма); 
		ДобавитьПолеВГруппуШапкаЛево(Форма);
...
Процедура ДобавитьПолеВГруппуШапкаЛево(Форма)
//НачалоДоработки
//Королёв Р.В.17.03.2024 
//Добавляет на форму группу "Скидки" и элементы в неё: Кнопка команды и поле ввода 	
		
	Группа = Форма.Элементы.Добавить("KRV_ГруппаСкидки", Тип("ГруппаФормы"), Форма.Элементы.ГруппаШапкаЛево);
	Группа.Вид = ВидГруппыФормы.ОбычнаяГруппа;
	Группа.Отображение = ОтображениеОбычнойГруппы.Нет;
	Группа.ОтображатьЗаголовок = Ложь;
	Группа.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	
	ПолеВвода = Форма.Элементы.Добавить("KRV_СогласованнаяСкидка", Тип("ПолеФормы"), Группа);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "Объект.KRV_СогласованнаяСкидка";
	ПолеВвода.УстановитьДействие("ПриИзменении", "KRV_СогласованнаяСкидкаПриИзменении"); 
		
	Кнопка = Форма.Элементы.Добавить("KRV_ПересчитатьТабличныеЧасти", Тип("КнопкаФормы"), Группа);
	Кнопка.ИмяКоманды = "KRV_ПересчитатьТабличныеЧасти";
